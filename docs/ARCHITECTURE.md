...
| `image.rs` | `save_image` / `copy_image_to_vault` — save editor image attachments with sanitized filenames into the configured or detected attachments folder |
...
| `save_image` | Save base64 image to the configured or detected attachments folder and ensure the vault root is in the runtime asset scope |
| `copy_image_to_vault` | Copy image file to the configured or detected attachments folder and ensure the vault root is in the runtime asset scope |
